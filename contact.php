            ...
            <section>
                ...
                <div class="container">
                    ...
                    <form action="" method="post">
                            ...
                            <input type="text" class="form-control" id="fname" name="firstname" placeholder="Your name.." value="<?php echo isset($_POST['firstname']) ? htmlspecialchars($_POST['firstname']) : ''; ?>"/>
                            <small style="color: red"><?php if(isset($fnerror))if(!is_null($fnerror) ) echo $fnerror; ?></small>
                            </div>
                            <div class="form-group"> 
                            <label for="lname">Last Name*</label>
                            <input type="text" class="form-control" id="lname" name="lastname" placeholder="Your last name.." value="<?php echo isset($_POST['lastname']) ? htmlspecialchars($_POST['lastname']) : ''; ?>"/>
                             <small style="color: red"><?php if(isset($lnerror))if(!is_null($lnerror) ) echo $lnerror; ?></small>
                            </div> 
                            <div class="form-group">
                            <label for="email">Email Address*</label>
                            <input type="text" class="form-control" id="email" name="contactemail" placeholder="myemail@anyemail.com" value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>" />
                             <small style="color: red"><?php if(isset($emailerror))if(!is_null($emailerror) ) echo $emailerror; ?></small>
                            </div> 
                            <div class="form-group"> 
                            <label for="subject">Subject*</label>
                            <textarea id="subject" class="form-control" name="subject" placeholder="Write something.." style="height:200px"><?php echo isset($_POST['subject']) ? htmlspecialchars($_POST['subject']) : ''; ?></textarea>
                            <small style="color: red"><?php if(isset($subjecterror))if(!is_null($subjecterror) ) echo $subjecterror; ?></small>
                            </div> 
                            <div class="form-group">
                            <input type="submit" name="submit_contact_form" class="for-logging-in btn btn-outline-primary-2" value="Submit">
                            </div> 
