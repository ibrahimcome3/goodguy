						...
						<div class="row">
							<aside class="col-md-4 col-lg-3">
								<ul class="nav nav-dashboard flex-column mb-3 mb-md-0" role="tablist">
									...
									<li class="nav-item">
										<a class="nav-link active" id="tab-phone-link" data-toggle="tab"
											href="#tab-phone" role="tab" aria-controls="tab-phone"
									...
									<div class="tab-pane fade show active" id="tab-phone" role="tabpanel"
										...
										<div class="row">
											...
											<form action="edit-phone-number.php" method="post">
												<input value=<?php echo $_GET['phone_id'] ?> type=hidden
													name="phone_id">
												<input value="<?php echo $_GET['phone'] ?>" type="text" name="phone"
												...
												<div>
													...
													<button type="submit" onclick="location.href = 'dashboard.php';"
														class="btn cancel btn-outline-primary-2">
														<span>CANCEL</span>
														<i class="icon-long-arrow-right"></i>
													</button>
												</div>
