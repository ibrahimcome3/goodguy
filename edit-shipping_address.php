    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="login-page pb-8  pb-md-12 pt-lg-17 pb-lg-17">
                <div class="container">
                    <?php if (isset($error)) { ?>
                        <div class="alert alert-danger" role="alert"><?php if (isset($error)) {
                            echo $error;
                        } ?></div>
                    <?php } ?>
                    <div class="row">
                        <div class="col-lg-9">
                            <form action="" method="post">
                                ...
                                <input type="text" class="form-control" name="streetaddress1"
                                    value="<?= $row['address1'] ?>" placeholder="House number and Street name" required>
                                <input type="text" class="form-control" name="streetaddress2"
                                    value="<?= $row['address2'] ?>" placeholder="Appartments, suite, unit etc ..."
                                    required>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="state" id="state" class="form-control">
                                            ...
                                            while ($row__ = mysqli_fetch_array($s)) {
                                                ...
                                                <option value="<?= $row__['state_id'] ?>" <?php if ($row__['state_id'] == '21')
