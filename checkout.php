                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="create_an_account" class="custom-control-input"
                                        ...
                                        <table class="table table-summary">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) { ?>
                                                    <tr>
                                                        <td><a
                                                                href="#"><?= $row['description'] . " " . $row['InventoryItemID'] ?></a>
                                                        </td>
                                                        <td>
                                                            <?php
                                                            $val_ = 0;
                                                ...
                                                <tr>
                                                    ...
                                                    } elseif (isset($_GET['express_shipping'])) {
                                                        echo $_GET['express_shipping'];
                                                        $shipping = $_GET['express_shipping'];
                                                    } ?>
                                                    </td>
                                                </tr>
                                                <tr class="summary-total">
                                                    <td>Total:</td>
                                                    <td><?php echo $shipping + $val_total;
                                                    $_SESSION['shipping'] = $shipping; //var_dump( $_SESSION); ?>
                                                    </td>
                                        ...
                                        <div class="accordion-summary" id="accordion-payment">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapse-3" class="collapse" aria-labelledby="heading-3"
                                                    ...
                                                    <div class="card-body">Make your payments once you receive your
                                                        order.
                                                    </div><!-- End .card-body -->
                                                </div><!-- End .collapse -->
                                            </div><!-- End .card -->
