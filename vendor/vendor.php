            ...
            <div class="col">
              ...
              <form action="" method="post" class="dropzone" id="my-dropzone">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="pname" name="product_description"
                    placeholder="Your name.." />

                </div>
                <div class="form-group">
                  <label for="product_description">Product Description* (0/300)</label>
                  <textarea id="subject" class="form-control" name="product_description" placeholder=""
                    style="height:200px"></textarea>

                </div>
                <div class="form-group">
                  <label for="uniform_product_number">Uniform product code*</label>
                  <input type="text" class="form-control" id="uniform_product_number" name="uniform_product_number"
                    placeholder="" />

                </div>
                <div class="form-group">
                  <label for="product_sku_number">Product SKU NUmber*</label>
                  <input type="text" class="form-control" id="product_sku_number" name="product_sku_number"
                ...
                <div class="form-group">
                  <input type="submit" name="submit_contact_form" class="for-logging-in btn btn-outline-primary-2"
                    value="Add Product">
                </div>
