                ...
                <div class="col">
                    <div
                        ...
                        <div>
                            ...
                            $lm->table = 'inventoryitem';
                            $lm->identity_name = 'InventoryItemID';
                            $lm->grid_sql = "SELECT `InventoryItemID`, `description`, `quantityOnHand`, `cost`, `reorderQuantity`, `productItemID`,  `sku`, `barcode`, `InventoryItemID` FROM `inventoryitem` WHERE `productItemID` = 143";
