...
$statusFilter = 'completed'; // Hardcoded for this page
...
// Note: The getTotalOrderCount method in Order.php doesn't currently account for the search term.
// This means the total count might be inaccurate when searching.
        ...
        <div class="content">
            ...
            <div class="mb-9">
                <div class="row g-3 mb-4">
                    <div class="col-auto">
                        <h2 class="mb-0"><span class="fas fa-check-circle me-2"></span>Completed Orders <span
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <form method="get" action="completed-orders.php">
                                        ...
                                        <?php if (empty($orders)): ?>
                                            <tr>
                                                <td colspan="6" class="text-center py-5">
                                                    <div class="text-body-tertiary">No completed orders found.</div>
                                                </td>
                                            </tr>
                                        <?php else: ?>
