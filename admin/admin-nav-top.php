<nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
    <div class="collapse navbar-collapse justify-content-between">
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="phoenix-v1.20.1/public/index.html">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center"><img src="phoenix-v1.20.1/public/assets/img/icons/logo.png"
                                    ...
                                    <div class="simplebar-content" style="padding: 0px;">
                                        <div class="list pb-3">
                                            ...
                                            <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                                    ...
                                                    <div class="flex-1">
                                                        <h6 class="mb-0 text-body-highlight title">Carry Anna
                                                        </h6>
                                                ...
                                                <a class="dropdown-item py-2 d-flex align-items-center"
                                                    ...
                                                    <div class="flex-1">
                                                        <h6 class="mb-0 text-body-highlight title">John Smith
                                                        </h6>
                                                        <p class="fs-10 mb-0 d-flex text-body-tertiary">
                                                            smith@technext.it</p>
                                                    </div>
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
            <li class="nav-item">
                <div class="theme-control-toggle fa-icon-wait px-2">
                    ...
                    <label class="mb-0 theme-control-toggle-label theme-control-toggle-light" for="themeControlToggle"
                        ...
                        style="height:32px;width:32px;"><svg xmlns="http://www.w3.org/2000/svg" width="16px"
                    ...
                    <div class="card position-relative border-0">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="avatar avatar-m status-online me-3">
                                                                    <img class="rounded-circle"
                                                                        src="phoenix-v1.20.1/public/assets/img/team/40x40/30.webp"
                                                                        alt="">
                                                                </div>
                                                                <div class="flex-1 me-sm-3">
                                                                    ...
                                                                    <p class="text-body-secondary fs-9 mb-0">
                                                                        ...
                                                                        </svg><!-- <span class="me-1 fas fa-clock"></span> Font Awesome fontawesome.com --><span
                                                                            class="fw-bold">10:41 AM
                                                                        </span>August 7,2021
                                                                    </p>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-1 me-sm-3">
                                                                    <h4 class="fs-9 text-body-emphasis">Jane
                                                                        Foster</h4>
                                                                    <p
                                                                        class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal">
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="avatar avatar-m status-online me-3">
                                                                    <img class="rounded-circle avatar-placeholder"
                                                                        src="phoenix-v1.20.1/public/assets/img/team/40x40/avatar.webp"
                                                                        alt="">
                                                                </div>
                                                                <div class="flex-1 me-sm-3">
                                                                    <h4 class="fs-9 text-body-emphasis">Jessie
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="avatar avatar-m status-online me-3">
                                                                    <img class="rounded-circle"
                                                                        src="phoenix-v1.20.1/public/assets/img/team/40x40/57.webp"
                                                                        alt="">
                                                                </div>
                                                                <div class="flex-1 me-sm-3">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="avatar avatar-m status-online me-3">
                                                                    <img class="rounded-circle"
                                                                        src="phoenix-v1.20.1/public/assets/img/team/40x40/59.webp"
                                                                        alt="">
                                                                </div>
                                                                <div class="flex-1 me-sm-3">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="avatar avatar-m status-online me-3">
                                                                    <img class="rounded-circle"
                                                                        src="phoenix-v1.20.1/public/assets/img/team/40x40/58.webp"
                                                                        alt="">
                                                                </div>
                                                                <div class="flex-1 me-sm-3">
                        ...
                        <div class="card-footer p-0 border-top border-translucent border-0">
                            <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a
                                    class="fw-bolder"
                                    href="phoenix-v1.20.1/public/pages/notifications.html">Notification
                                    history</a></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                            <div class="row text-center align-items-center gx-0 gy-0">
                                <div class="col-4"><a
                                        ...
                                        href="#!"><img src="phoenix-v1.20.1/public/assets/img/nav-icons/behance.webp"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="phoenix-v1.20.1/public/assets/img/nav-icons/google-cloud.webp" alt=""
                                            width="30">
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button"
                    ...
                    <div class="avatar avatar-l ">
                        <img class="rounded-circle " src="phoenix-v1.20.1/public/assets/img/team/40x40/57.webp" alt="">
                        ...
                        <div class="card-body p-0">
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl ">
                                    <img class="rounded-circle "
                                        src="phoenix-v1.20.1/public/assets/img/team/72x72/57.webp" alt="">
