...
class lazy_mofo{
    ...
    public $grid_filter_type = '';//$_GET['search_by'] ?? null;

    // search box
   // public $grid_search_box = "<form action='[script_name]' class='lm_search_box'><select name='search_by'  style='margin-right: 10px;'>    <option value='an' ". (isset($this->grid_filter_type) && $this->grid_filter_type === 'an') ? 'selected' : ''.">Account Number</option>      <option value='acn' ". (isset($this->grid_filter_type) && $this->grid_filter_type === 'acn') ? 'selected' : ''.">Account Name</option>         <option value='bvn' ". (isset($this->grid_filter_type) && $this->grid_filter_type === 'bvn') ? 'selected' : ''.">Bank Verifivation Number</option></select>    <input type='text' name='_search' value='[_search]' size='20' class='lm_search_input'><a href='[script_name]' style='margin: 0 10px 0 -20px; display: inline-block;' title='Clear Search'>x</a><input type='submit' class='lm_button lm_search_button' value='Search'><input type='hidden' name='action' value='search'>[query_string_list]</form>";
    public $grid_search_box = "<form action='[script_name]' class='lm_search_box'><select name='search_by'  style='margin-right: 10px;'>    <option value='an'>Account Number</option>      <option value='acn'>Account Name</option>         <option value='bvn'>Bank Verifivation Number</option></select>    <input type='text' name='_search' value='[_search]' size='20' class='lm_search_input'><a href='[script_name]' style='margin: 0 10px 0 -20px; display: inline-block;' title='Clear Search'>x</a><input type='submit' class='lm_button lm_search_button' value='Search'><input type='hidden' name='action' value='search'>[query_string_list]</form>";
    // grid messages
    ...
    function __construct($dbh, $i18n = 'en-us'){
        ...
        $this->grid_filter_type = $_GET['search_by'];
        $this->grid_search_box = "<form action='[script_name]' class='lm_search_box'><select name='search_by'  style='margin-right: 10px;'>    <option value='an' ";
        $this->grid_search_box  .= (isset($this->grid_filter_type) && $this->grid_filter_type === 'an') ? 'selected' : '';
        $this->grid_search_box  .= ">Account Number</option>      <option value='acn' ";
        $this->grid_search_box  .= (isset($this->grid_filter_type) && $this->grid_filter_type === 'acn') ? 'selected' : '';
        $this->grid_search_box  .=  ">Account Name</option>         <option value='bvn' ";
        $this->grid_search_box  .= (isset($this->grid_filter_type) && $this->grid_filter_type === 'bvn') ? 'selected' : '';
        $this->grid_search_box  .= ">Bank Verifivation Number</option></select>";
        $this->grid_search_box  .= "<input type='text' name='_search' value='[_search]' size='20' class='lm_search_input'><a href='[script_name]' style='margin: 0 10px 0 -20px; display: inline-block;' title='Clear Search'>x</a><input type='submit' class='lm_button lm_search_button' value='Search'><input type='hidden' name='action' value='search'>[query_string_list]</form>";
        }
